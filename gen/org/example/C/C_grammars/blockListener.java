...
public interface blockListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link blockParser#for_first_expr}.
	 * @param ctx the parse tree
	 */
	void enterFor_first_expr(blockParser.For_first_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link blockParser#for_first_expr}.
	 * @param ctx the parse tree
	 */
	void exitFor_first_expr(blockParser.For_first_exprContext ctx);
	/**
	 * Enter a parse tree produced by {@link blockParser#for_third_expr}.
	 * @param ctx the parse tree
	 */
	void enterFor_third_expr(blockParser.For_third_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link blockParser#for_third_expr}.
	 * @param ctx the parse tree
	 */
	void exitFor_third_expr(blockParser.For_third_exprContext ctx);
	/**
