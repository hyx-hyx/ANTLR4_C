...
public class for_stmtParser extends Parser {
	...
	public static final int
		...
		RULE_type_assign_stmt = 8, RULE_expr_assign_stmt = 9, RULE_assign_stmt = 10, 
		RULE_call = 11, RULE_callstmt = 12, RULE_vardecl = 13;
	private static String[] makeRuleNames() {
		return new String[] {
			"debug", "for_stmt", "statements", "block", "expr", "statement", "if_stmt", 
			"while_stmt", "type_assign_stmt", "expr_assign_stmt", "assign_stmt", 
			"call", "callstmt", "vardecl"
		};
	}
	...
	public static class StatementsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof for_stmtVisitor ) return ((for_stmtVisitor<? extends T>)visitor).visitStatements(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 158329674400788486L) != 0) {
				{
				{
				setState(54);
				statement();
	...
	public static class Type_assign_stmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof for_stmtListener ) ((for_stmtListener)listener).enterType_assign_stmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof for_stmtListener ) ((for_stmtListener)listener).exitType_assign_stmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof for_stmtVisitor ) return ((for_stmtVisitor<? extends T>)visitor).visitType_assign_stmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Type_assign_stmtContext type_assign_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_type_assign_stmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(183);
	...
	public static class Expr_assign_stmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof for_stmtListener ) ((for_stmtListener)listener).enterExpr_assign_stmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof for_stmtListener ) ((for_stmtListener)listener).exitExpr_assign_stmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof for_stmtVisitor ) return ((for_stmtVisitor<? extends T>)visitor).visitExpr_assign_stmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Expr_assign_stmtContext expr_assign_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_expr_assign_stmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(194);
	...
	public static class CallContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof for_stmtVisitor ) return ((for_stmtVisitor<? extends T>)visitor).visitCall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CallstmtContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof for_stmtVisitor ) return ((for_stmtVisitor<? extends T>)visitor).visitCallstmt(this);
			else return visitor.visitChildren(this);
		}
	}
