...
public interface while_stmtVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link while_stmtParser#for_first_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFor_first_expr(while_stmtParser.For_first_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link while_stmtParser#for_third_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFor_third_expr(while_stmtParser.For_third_exprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link while_stmtParser#call}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCall(while_stmtParser.CallContext ctx);
}