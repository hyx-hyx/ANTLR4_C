...
public interface while_stmtListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link while_stmtParser#for_first_expr}.
	 * @param ctx the parse tree
	 */
	void enterFor_first_expr(while_stmtParser.For_first_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link while_stmtParser#for_first_expr}.
	 * @param ctx the parse tree
	 */
	void exitFor_first_expr(while_stmtParser.For_first_exprContext ctx);
	/**
	 * Enter a parse tree produced by {@link while_stmtParser#for_third_expr}.
	 * @param ctx the parse tree
	 */
	void enterFor_third_expr(while_stmtParser.For_third_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link while_stmtParser#for_third_expr}.
	 * @param ctx the parse tree
	 */
	void exitFor_third_expr(while_stmtParser.For_third_exprContext ctx);
	/**
