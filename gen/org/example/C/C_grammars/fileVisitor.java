...
public interface fileVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link fileParser#for_first_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFor_first_expr(fileParser.For_first_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link fileParser#for_third_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFor_third_expr(fileParser.For_third_exprContext ctx);
	/**
