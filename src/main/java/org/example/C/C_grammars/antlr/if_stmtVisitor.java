...
public interface if_stmtVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link if_stmtParser#call}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCall(if_stmtParser.CallContext ctx);
	/**
	 * Visit a parse tree produced by {@link if_stmtParser#callstmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCallstmt(if_stmtParser.CallstmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link if_stmtParser#for_first_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFor_first_expr(if_stmtParser.For_first_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link if_stmtParser#for_third_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFor_third_expr(if_stmtParser.For_third_exprContext ctx);
	/**
