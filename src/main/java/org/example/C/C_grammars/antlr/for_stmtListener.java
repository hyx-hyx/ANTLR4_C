...
public interface for_stmtListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link for_stmtParser#type_assign}.
	 * @param ctx the parse tree
	 */
	void enterType_assign(for_stmtParser.Type_assignContext ctx);
	/**
	 * Exit a parse tree produced by {@link for_stmtParser#type_assign}.
	 * @param ctx the parse tree
	 */
	void exitType_assign(for_stmtParser.Type_assignContext ctx);
	/**
	 * Enter a parse tree produced by {@link for_stmtParser#expr_assign}.
	 * @param ctx the parse tree
	 */
	void enterExpr_assign(for_stmtParser.Expr_assignContext ctx);
	/**
	 * Exit a parse tree produced by {@link for_stmtParser#expr_assign}.
	 * @param ctx the parse tree
	 */
	void exitExpr_assign(for_stmtParser.Expr_assignContext ctx);
	/**
