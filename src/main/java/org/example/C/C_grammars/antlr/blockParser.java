...
public class blockParser extends Parser {
	...
	public static final int
		RULE_debug = 0, RULE_statements = 1, RULE_block = 2, RULE_expr = 3, RULE_statement = 4, 
		RULE_if_stmt = 5, RULE_while_stmt = 6, RULE_type_assign = 7, RULE_expr_assign = 8, 
		RULE_assign_stmt = 9, RULE_call = 10, RULE_callstmt = 11, RULE_for_stmt = 12, 
		RULE_vardecl = 13;
	private static String[] makeRuleNames() {
		return new String[] {
			"debug", "statements", "block", "expr", "statement", "if_stmt", "while_stmt", 
	...
	public static class StatementsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).enterStatements(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).exitStatements(this);
		}
	}
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 367395213351844928L) != 0) {
				{
				{
				setState(30);
				statement();
	...
	public static class Type_assignContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).enterType_assign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).exitType_assign(this);
		}
	}
	...
	public static class Expr_assignContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).enterExpr_assign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).exitExpr_assign(this);
		}
	}
	...
	public static class CallstmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).enterCallstmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof blockListener ) ((blockListener)listener).exitCallstmt(this);
		}
	}
	...
	public static class For_stmtContext extends ParserRuleContext {
		public TerminalNode FOR() { return getToken(blockParser.FOR, 0); }
		public BlockContext block() {
			return getRuleContext(BlockContext.class,0);
		}
		public Type_assignContext type_assign() {
