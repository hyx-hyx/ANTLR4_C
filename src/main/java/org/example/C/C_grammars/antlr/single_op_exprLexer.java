...
public class single_op_exprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__41", "WS", "Type", "INT", "STRING", "ESC", "LINE_COMMENT", "COMMENT", 
			"ID", "NEWLINE"
		};
	}
	...
	public single_op_exprLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "single_op_expr.g4"; }
