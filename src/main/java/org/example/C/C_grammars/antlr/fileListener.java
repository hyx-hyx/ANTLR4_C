...
public interface fileListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link fileParser#statements}.
	 * @param ctx the parse tree
	 */
	void enterStatements(fileParser.StatementsContext ctx);
	/**
	 * Exit a parse tree produced by {@link fileParser#statements}.
	 * @param ctx the parse tree
	 */
	void exitStatements(fileParser.StatementsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link fileParser#type_assign}.
	 * @param ctx the parse tree
	 */
	void enterType_assign(fileParser.Type_assignContext ctx);
	/**
	 * Exit a parse tree produced by {@link fileParser#type_assign}.
	 * @param ctx the parse tree
	 */
	void exitType_assign(fileParser.Type_assignContext ctx);
	/**
	 * Enter a parse tree produced by {@link fileParser#expr_assign}.
	 * @param ctx the parse tree
	 */
	void enterExpr_assign(fileParser.Expr_assignContext ctx);
	/**
	 * Exit a parse tree produced by {@link fileParser#expr_assign}.
	 * @param ctx the parse tree
	 */
	void exitExpr_assign(fileParser.Expr_assignContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link fileParser#head}.
	 * @param ctx the parse tree
	 */
	void enterHead(fileParser.HeadContext ctx);
	/**
	 * Exit a parse tree produced by {@link fileParser#head}.
	 * @param ctx the parse tree
	 */
	void exitHead(fileParser.HeadContext ctx);
	/**
