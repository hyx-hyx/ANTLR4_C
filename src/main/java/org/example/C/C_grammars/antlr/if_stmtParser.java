...
public class if_stmtParser extends Parser {
	...
	public static final int
		RULE_debug = 0, RULE_if_stmt = 1, RULE_expr = 2, RULE_statements = 3, 
		RULE_block = 4, RULE_statement = 5, RULE_while_stmt = 6, RULE_type_assign = 7, 
		RULE_expr_assign = 8, RULE_assign_stmt = 9, RULE_call = 10, RULE_callstmt = 11, 
		RULE_for_stmt = 12, RULE_vardecl = 13;
	private static String[] makeRuleNames() {
		return new String[] {
			"debug", "if_stmt", "expr", "statements", "block", "statement", "while_stmt", 
	...
	public static class StatementsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof if_stmtListener ) ((if_stmtListener)listener).enterStatements(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof if_stmtListener ) ((if_stmtListener)listener).exitStatements(this);
		}
	}
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 367324844607536646L) != 0) {
				{
				{
				setState(119);
				statement();
	...
	public static class Type_assignContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof if_stmtListener ) ((if_stmtListener)listener).enterType_assign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof if_stmtListener ) ((if_stmtListener)listener).exitType_assign(this);
		}
	}
	...
	public static class Expr_assignContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof if_stmtListener ) ((if_stmtListener)listener).enterExpr_assign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof if_stmtListener ) ((if_stmtListener)listener).exitExpr_assign(this);
		}
	}
	...
	public static class For_stmtContext extends ParserRuleContext {
		public TerminalNode FOR() { return getToken(if_stmtParser.FOR, 0); }
		public BlockContext block() {
			return getRuleContext(BlockContext.class,0);
		}
		public Type_assignContext type_assign() {
